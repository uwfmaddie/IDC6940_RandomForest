...
We found there to be no missing data in the data exploration phase, and
therefore will not remove null values. We did find that there were some
RestingBP and Cholesterol values of 0.
